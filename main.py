		...
		if user.id == message.from_user.id:
			...
			if user.mode =='test_dialog':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_travel_about_myself').fetchall()) - 1))
			...
			if user.mode == 'test_dialog_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM travel_about_myself").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_communication':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_myself_basic_communication').fetchall()) - 1))
			...
			if user.mode == 'test_communication_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM myself_basic_communication").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_colorandnumer':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_myself_basic_colorandnumer').fetchall()) - 1))
			...
			if user.mode == 'test_colorandnumer_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM myself_basic_colorandnumer").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_eat':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_myself_basic_eat').fetchall()) - 1))
			...
			if user.mode == 'test_eat_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM myself_basic_eat").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_transport':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_myself_medium_transport').fetchall()) - 1))
			...
			if user.mode == 'test_transport_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM myself_medium_transport").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_hobbies':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_myself_medium_hobbies').fetchall()) - 1))
			...
			if user.mode == 'test_hobbies_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM myself_medium_hobbies").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_family':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_myself_medium_family').fetchall()) - 1))
			...
			if user.mode == 'test_family_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM test_myself_medium_family").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_clothes':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_myself_medium_clothes').fetchall()) - 1))
			...
			if user.mode == 'test_clothes_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM myself_medium_clothes").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_body':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_myself_hard_body').fetchall()) - 1))
			...
			if user.mode == 'test_body_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM myself_hard_body").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_nature':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_myself_hard_nature').fetchall()) - 1))
			...
			if user.mode == 'test_nature_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM myself_hard_nature").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_stuart':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_prof_avia').fetchall()) - 1))
			...
			if user.mode == 'test_stuart_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM prof_avia").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_economy':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_prof_economy').fetchall()) - 1))
			...
			if user.mode == 'test_economy_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM prof_economy").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_enginere':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_prof_engineer').fetchall()) - 1))
			...
			if user.mode == 'test_enginere_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM prof_engineer").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_guide':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_prof_gids').fetchall()) - 1))
			...
			if user.mode == 'test_guide_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM prof_gids").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode =='test_prog':
				...
				if user.i == len(rows):
					user.i = 0
					user.l = random.randint(0,
											(len(c.execute(f'SELECT * FROM test_prof_programmer').fetchall()) - 1))
			...
			if user.mode == 'test_prog_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM prof_programmer").fetchall()[user.i][1]).lower().replace(' ',''):
			...
			if user.mode == 'test_place_1':
				...
				b_menu = KeyboardButton(text="В главное меню")
				kb.add(b_menu)
				if str(message.text).lower().replace(' ','') == str(c.execute("SELECT * FROM travel_local").fetchall()[user.i][1]).lower().replace(' ',''):
